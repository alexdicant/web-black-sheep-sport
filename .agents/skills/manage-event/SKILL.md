---
name: manage-event
description: Create or announce an event, change event data or status, transfer the featured event, or prepare the next event in Black Sheep Sport. Use for event registration and lifecycle changes; follow EVENTOS.md as the operational source of truth.
---

# Manage an event

Use this procedure for event records and lifecycle changes. Read [EVENTOS.md](../../../EVENTOS.md) first; consult [docs/ARCHITECTURE.md](../../../docs/ARCHITECTURE.md) for technical ownership. Do not restate or override those sources.

## Before editing

1. Read `EVENTOS.md`, `src/data/events.ts`, `src/pages/eventos/[slug].astro`, and `docs/ARCHITECTURE.md`.
